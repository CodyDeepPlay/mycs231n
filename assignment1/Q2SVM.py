# -*- coding: utf-8 -*-
"""
Created on Tue Sep  3 21:08:49 2019
...
f = lambda w: svm_loss_naive(w, X_dev, y_dev, 0.0)[0]  # lambda operator, create a throw-away function
...
print('difference: %f' % (grad_difference))
...
num_iters = 900   # start with a small number
for my_lr in learning_range:
    for my_reg in reg_range:
